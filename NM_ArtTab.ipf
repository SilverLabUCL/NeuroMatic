...
Function NMArtWavesCheck( [ forceMake ] )
	...
	if ( thisIsAnArtWave || !WaveExists( $dName ) )
		return 0
	endif
...
Function NMArtRestore()
	...
	if ( !WaveExists( $noStimName ) || !WaveExists( $dName ) )
		return -1
	endif
	...
	if ( numpnts( $noStimName ) != numpnts( $dName ) )
		return -1
	endif
